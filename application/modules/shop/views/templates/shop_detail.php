...
<section class="section_offset single_shop_profilepic">

    <!-- - - - - - - - - - - - - - Banner Category - - - - - - - - - - - - - - - - -->

    <a href="#" class="banner">

        <img src="<?php echo $store_cover; ?>" alt="<?php echo $store_name; ?>">

    </a>

    <!-- - - - - - - - - - - - - - End of Banner Category - - - - - - - - - - - - - - - - -->
...
<section class="section_offset single_shop_share">
					<!-- - - - - - - - - - - - - - Share - - - - - - - - - - - - - - - - -->

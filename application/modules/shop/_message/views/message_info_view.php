...
<div class="secondary_page_wrapper">
			...
			<div class="container">
				...
				<ul class="breadcrumbs">
					...
					<li><a href="javascript:void(0);">ข้อความ</a></li>
											...
											<div id="tab-7" class="tab_container ">
                                                    ...
                                                    <div class="row pt-20 pr-20 pl-20">
                                                        <div class="col-md-12 theme_box">
                                                            <h4><?php echo $message_topic; ?></h4>
                                                            <p class="pre_date">เริ่มส่งโดย <?php echo $create_name; ?> เมื่อ <?php echo $this->utils->getThaiDate($timestamp); ?></p>
													...
													<div class="row pt-20 pr-20 pl-20">
                                                        <div class="col-md-12 theme_box">
                                                            <p class="pre_date">ตอบกลับโดย <?php echo $member_name; ?> เมื่อ <?php echo $this->utils->getThaiDate($last_time_send); ?></p>
                                                            <p><?php echo $message; ?></p>
                                                        </div>
                                                    </div>
                                                     <?php }  } ?>

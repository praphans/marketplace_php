...
<html lang="en">
	<head>
		...
		foreach($news as $row){
			...
			$this->db->where_in("tag_id",$new_tags_arr);
			$query = $this->db->get();
			if($query->num_rows() > 0 ) {
				$tags = $query->result();
			} else {
        ...
        <meta property="og:url" content="<?php echo base_url("news/info/".$new_id."/".$new_header_url); ?>" />
        <meta property="og:type" content="article" />
        <meta property="og:title" content="<?php echo $new_header; ?>" />
        <meta property="og:description" content="<?php echo $this->utils->shareClean($new_content); ?>" />
        <meta property="og:image" content="<?php echo base_url($new_image); ?>" />
		<meta property="og:image:secure_url" content="<?php echo base_url($new_image); ?>" /> 
            ...
            <main class="col-md-12 col-sm-12 col-xs-12">	
                ...
                <div>
                        <article class="entry">
                                ...
                                <div class="thumbnail entry_image_set">

                                    <img  src="<?php echo base_url($new_image); ?>" alt="<?php echo $new_header; ?>">

                                </div>

                                <h5 class="entry_title"><b><?php echo $new_header; ?></b></h5>

                                <div class="entry_meta">

                                    <span><i class="icon-calendar"></i>
 <?php echo $this->utils->getThaiDate($timestamp); ?></span>

                                </div><!--/ .entry_meta-->

                                <p><?php echo $new_content; ?></p>
                                
                                <div class="pt-15 padding-l_0 col-md-12 col-sm-12 col-xs-12">
                                    
                                    <div class="col-md-3 col-sm-10 col-xs-12 .padding-l_0">
                                    ...
                                    <div  class="col-md-9 col-sm-10 text-right">
                                        <a href="<?php echo base_url("news"); ?>" class="">กลับสู่หน้ารวมข่าวสาร</a>
                                    </div>  
                                </div>
                ...
                <!--<div class="row pt-5">
                        ...
                        <div class="col-md-4 col-md-offset-4 col-xs-12 col-sm-12 pt-15  ">
                            <a href="<?php echo base_url("news"); ?>" class="btn-block button_blue middle_btn">กลับสู่หน้ารวมข่าวสาร</a>
                        </div>
                </div>-->

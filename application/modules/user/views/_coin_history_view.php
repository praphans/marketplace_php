                                    ...
                                    <div id="cion_customer" class="tab_container">
                                        <div class="row">
                                            <div class="col-md-12 pt-10">
                                                ...
                                                <span>จำนวนเหรียญที่คุณมี &nbsp&nbsp<strong class="text-primary font-icon"><?php echo number_format($member_coin); ?></strong> &nbsp&nbspเหรียญ</span>
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="total text-center" data-title="เติมเงิน">
                                                                    <?php echo number_format($coin_top_up,0); ?> บาท
                                                                </td>
                                                            </tr>
                                                            <?php } ?>

...
<form action="<?php echo base_url("cart/createlocation"); ?>" method="post">
                ...
                <table class="table_type_1 shopping_cart_table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td data-title="จำนวน" valign="middle" class="cart<?php echo $store_id; ?>">
                                ...
                                <div class="qty min clearfix cart<?php echo $store_id; ?>" >
                                    <button type="button" class="theme_button product_qty_btn" onclick="minusCart(<?php echo $product_id; ?>);" data-direction="minus">&#45;</button>
                                    <input type="text" name="product_qty[]" class="product_qty" product_price_discount="<?php echo $product_price_discount; ?>" value="<?php echo $product_qty_total; ?>">
                            ...
                            <td class="total text-md-center-left product_price_discount_total" data-title="ราคารวม" valign="middle">
                                ฿<?php echo number_format($product_price_discount_total,2); ?>
                            </td>
                            <td data-title="ลบสินค้า" valign="middle">
            ...
            <div class="row">
                ...
                <section class="col-sm-6 col-md-4">
                    ...
                    <footer class="bottom_box">
                        ...
                        <button type="submit" class="button_blue middle_btn btn-block icon-truck"> เลือกวิธีรับสินค้า</button>

                    	...
                    	<?php 
							...
							foreach($product_in_cart as $row2){
								...
								foreach($is_relate_or_not as $re){
									...
									$product_relate_name = $re->product_name;
								}
								...
								if($relate_id > 0){
									...
									$related = $this->model_location->getProductNameByID($relate_id);
                        ...
                        <tr>
                            ...
                            <td class="product_image_col" data-title="รูปสินค้า">
                               ...
                               <!-- แสดงใน mobile-->
                                <div class="row mobile_only_show" id="cart_mobile">
                                    <div class="col-xs-4 mobile_cart_img">
                                        <a href="<?php echo $link; ?>"><img src="<?php echo base_url($product_image); ?>" alt="<?php echo $product_name; ?>"></a>
                                    </div>
                                    <div class="col-xs-6 mobile_cart_img">
                                        <div class="row">
                                            <div class="col-xs-12">
                                                <a href="<?php echo $link; ?>" class="product_title"><?php echo $product_name; ?></a>
                                            </div>
                                            <div class="col-xs-12">
                                                <a href="<?php echo $link; ?>" class="text-muted"><?php echo $product_version; ?></a>
                                            </div>
                                            
                                            <div class="col-xs-12 mobile_cart_price">
                                                 ฿<?php echo number_format($product_price_discount,2); ?>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-xs-2 mobile_cart_img" style="position: absolute; top: 12%; right: -4%;">
                                    ...
                                    <div class="col-xs-12 pt-20">
                                        <div class="row">
                                            <div class="qty clearfix cart<?php echo $store_id; ?> col-xs-7">
                                            ...
                                            <div class="total product_price_discount_total mobile_cart_price col-xs-5 text-right">
                            ...
                            <td class="tb_mobile_none" data-title="ชื่อสินค้า" valign="middle">
                                ...
                                <ul class="sc_product_info">
                                    ...
                                    <li><?php echo $product_relate_name; ?></li>

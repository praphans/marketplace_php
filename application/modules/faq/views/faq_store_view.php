    ...
    <div class="container">
        ...
        <div class="row pt-5">
            ...
            <div class="col-md-12 col-sm-12 col-xs-12 padding-l_0">
              ...
              <div class="col-md-12">
                    <ul class="tabs_nav clearfix margin-r-0">
                         <li><a class="col-md-6 col-sm-6 col-xs-12 text-center middle_btn " href="<?php echo base_url("faq/user"); ?>">บัญชีผู้ซื้อ</a></a></li>
                        <li class="active"><a class="col-md-6 col-sm-6 col-xs-12 text-center middle_btn " href="<?php echo base_url("faq/store"); ?>">บัญชีร้านค้า</a></li>
                    </ul>
              </div>
            ...
            <!--      <ul class="ts_nav clearfix ">
                ...
                <ul class="ts_nav width-245 width-250 width-150"><!-- theme_menu -->
                    <?php 
					...
					?>
                    <li class="<?php echo $active; ?>"><a class="size_font-16 pt-l-20 mb-pl-0 " href="<?php echo base_url("faq/store/".$faq_category_id); ?>"><?php echo $category_name; ?></a></li>

...
<div class="theme_box">
	<div class="row" style="float:right;">
        <div class="col-md-12">
          <button data-toggle="modal" data-target ="#modal_shop_agent_address" class="btn-block button_blue middle_btn text-center"><i class="icon-plus"></i>เพิ่มสถานที่</button>
        </div>
	</div>
    
    <?php
	
	foreach($agent_place as $row){
		...
		if(empty($place_condition))$place_condition = '-';
	?>
    <div class="row">
        <div class="col-xs-12">
        ...
        <div class="col-md-10 form_group">
            ...
            <span class="label label-success">ยังไม่อนุมัติ</span>
            <?php } ?>
        </div>
        <div class="col-md-2 form_group">
            <label>เจ้าของ :</label>

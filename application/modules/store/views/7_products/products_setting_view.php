                                ...
                                <div class="col-xs-12">
                                    <form class="type_2">
                                        ...
                                        <div>
                                            ...
                                            <div class="row">
                                                <div class="col-xs-12">
                                                    <h4>สินค้า : <?php echo $product_name; ?><h4>
                                                            ...
                                                            <div id="relate_container_one">
                                                                ...
                                                                <div class="theme_box">
                                                                    ...
                                                                    <div id="promotion_container">
                                                                        ...
                                                                        <div class="row pt-10">
                                                                            ...
                                                                            <!-- 2 -->
                                                                            <div class="col-xs-4 ">
                                                                                <input  onkeypress='return isNumberKey(event)' class="form-control" type="number" name="promo_price" id="promo_price" placeholder="" step="0.01" min="0" max="100000" value="<?php echo $promo_price; ?>">
                                                                            </div>
                                                                        </div>
                                                                ...
                                                                <div class="theme_box">
                                                                    ...
                                                                    <div class="theme_box pb-10">
																		...
																		?>
                                                                        <div id="promo_join<?php echo $join_id; ?>"> 
                                                                        <div class="row pt-10" >
                                                                            <div class="col-xs-12">
                                                                    ...
                                                                    <!-- โปรโมชั่นที่ได้รับเชิญ จะกลายไปเป็นโปรโมชั่นร่วม -->
                                                                    	<?php
																			...
																			foreach($promotions_join as $row){
																				...
																				$timestamp = ($join_startdate." ".$join_starttime);
                                                                    ...
                                                                    <div class="row pt-10">
                                                                        <div class="col-md-12 ">
                                                                            <div class="row pt-10">
                                                                                ...
                                                                                <div class="col-md-6 pt-5">
                                                                                        <input type="number" onkeypress='return isNumberKey(event)' step="0.01" min="0" max="100000" name="promo_price" id="promo_price" value="0">
                                                                        ...
                                                                        <div class="col-md-4 col-xs-12 pt-5 margin_m_t_0">
                                                                            ...
                                                                            <button type="button" onclick="savePromotionJoin(this);" class="btn-block button_blue">เข้าร่วมโปรโมชั่น</button>
...
var promo_price = "<?php if(isset($promo_price)) echo $promo_price; ?>";

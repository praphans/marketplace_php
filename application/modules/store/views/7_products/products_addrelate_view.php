...
<div class="secondary_page_wrapper">
				...
				<div class="container">
					...
					<ul class="breadcrumbs">
						...
						<li><a href="<?php echo base_url("store/dashboard"); ?>" class="notcursor">บัญชีร้านค้า</a></li>
						<li><a href="<?php echo base_url("store/products"); ?>" class="notcursor">จัดการสินค้า</a></li>
						<li><a href="<?php echo base_url("store/products/relate/".$product_id); ?>" class="notcursor">ตัวเลือกสินค้า</a></li>
						<li>เพิ่มตัวเลือกสินค้า</li>
					...
					<div class="row">
                        ...
                        <form id="form_product_edit" class="type_2" action="<?php echo base_url('store/products/insertrelateProduct'); ?>" method="post" enctype="multipart/form-data">
						<main class="col-md-9 col-sm-8 padding-l-0">

							<h2>เพิ่มตัวเลือกสินค้า</h2>
							...
							<div class="theme_box">
								<div class="row">
									<div class="col-xs-12">
										<h4><i class="icon-doc-new"></i>เพิ่มข้อมูลทั่วไปตัวเลือกของสินค้า</h4>
									</div>
									<div class="col-xs-12">
											...
											<ul>
												...
												<li class="row pt-20">
													<div class="col-xs-12">
														<label for="product_name" class="required">ชื่อตัวเลือก</label>
												...
												<!--<li class="row pt-20">
													<div class="col-xs-12">
														...
														<input type="text" name="product_brand" id="product_brand" value="<?php echo $product_brand; ?>" required>
													</div>
												</li>
												...
												<li class="row pt-20">
													<div class="col-xs-12">
														...
														<input type="text" name="product_version" id="product_version" value="<?php echo $product_version; ?>" required>
													</div>
												</li>-->
                                                <?php
												//&& $k1 != "product_brand" && $k1 != "product_version" && $k1 != "product_description"
												foreach($products as $k=>$v){
													foreach($v as $k1=>$v1){
														if($k1 != "product_name"){
															
												?>
												<input type="hidden" name="<?php echo $k1; ?>" value='<?php echo strip_tags($v1); ?>' />
                                                <?php }}} ?>
												<!--<li class="row pt-20">
													<div class="col-xs-12">
												...
												<li class="row pt-20">
													<div class="col-xs-12">
														...
														<div class="">
															<select name="product_subcategory" id="product_subcategory" required>
																<?php
																	$product_subcategorys = $this->productmanager->getProductSubcategory();
																	foreach($product_subcategorys as $row){
																		$id = $row->id;
							...
							<footer class="bottom_box on_the_sides">
								...
								<div class="col-md-4 col-xs-12">
									...
									<a href="<?php echo base_url("store/products/relate/".$product_id); ?>" class="btn-block button_dark_grey  middle_btn"><i class="icon-cancel-2"></i> ยกเลิก</a>

								</div>

								<!--<div class="col-md-4 col-xs-12">

									<button type="submit" name="product_status" value="1" class="btn-block button_grey middle_btn">ฉบับร่าง</button>

								</div>-->

								<div class="col-md-4 col-xs-12">

									<button type="submit" name="product_status" value="2" class="btn-block button_blue middle_btn"><i class="icon-check-1"></i> เพิ่ม</button>

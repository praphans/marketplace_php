...
<div class="secondary_page_wrapper">
				...
				<div class="container">
					...
					<div class="row">
                        ...
                        <form id="form_product_edit" class="type_2" action="<?php echo base_url('store/products/updaterelateProduct'); ?>" method="post" enctype="multipart/form-data">
                        	<input type="hidden" name="product_id" id="product_id" value="<?php echo $product_id; ?>">
                        	<input type="hidden" name="relate_id" id="relate_id" value="<?php echo $relate_id; ?>">
						<main class="col-md-9 col-sm-8 padding-l-0">
							...
							<div class="theme_box">
								<div class="row">
									<div class="col-xs-12">
										<h4><i class="icon-doc-new"></i>แก้ไขชื่อตัวเลือกสินค้า</h4>
									</div>
									<div class="col-xs-12">
							...
							<footer class="bottom_box on_the_sides">
								...
								<div class="col-md-4 col-xs-12">
									...
									<a href="<?php echo base_url("store/products/relate/".$relate_id); ?>" class="btn-block button_dark_grey  middle_btn"><i class="icon-cancel-2"></i> ยกเลิก</a>
								...
								<div class="col-md-4 col-xs-12">
									...
									<button type="submit" name="product_status" value="2" class="btn-block button_blue middle_btn"><i class="icon-check-1"></i> แก้ไข</button>

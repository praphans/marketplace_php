													...
													<div class="col-md-12">
														<ul class="list-group">
															...
															foreach($messages as $row){
																...
																if(count($member)){
																	$member_name = $member[0]->first_name;
																}
																echo $member_name."<br>";*/
																
																$is_show_in_list = true;
																if($filter == "receive"){
																	if($last_sender_id != $this->membermanager->member_id()){
																		$is_show_in_list = true;
																	}else{
															...
															?>
															<li class="list-group-item pt-10"><a class="<?php echo $active_pin; ?>" href="<?php echo $url_pin_unpin; ?>"><span class="<?php echo $icon_flag; ?> msg_icon pr-5 flag-inbox"></span></a> <a href="<?php echo base_url("message/info/".$filter."/".$message_type."/".$message_id); ?>" style="word-break:break-all;" class="text-info saveHome <?php echo $active; ?>"><?php echo $this->utils->string_shorten(strip_tags($message_topic),100,200); ?></a><p><?php echo $member_name." - ".$this->utils->time_ago($last_time_send); ?> <span class="icon-comment-alt"></span><?php echo $messages_num; ?></p></li>

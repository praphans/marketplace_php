 ...
 <div class="page-wrapper">
		...
		<div class="row page-titles">
			<div class="col-md-5 align-self-center">
				<h3 class="text-themecolor">ร้องเรียน</h3>
			</div>
							...
							<div class="card">
								<div class="card-body">
									<div class="row padding-mps_product">
										<div class="col-lg-12 pr-md-0 pr-lg-0">
									...
									<div class="table-responsive pr-3 pl-3">
										<div id="myTable_wrapper" class="dataTables_wrapper no-footer">
											<table id="massage_datatable" class="table table-bordered table-striped nowrap">
		                                        <thead>
		                                            <tr>
		                                            	<th>วันที่</th>
		                                            	<th>สมาชิก</th>
...
<?php $this->load->assets_by_name('massage'); ?>   

 ...
 <div class="page-wrapper mt-main-wrapper-70">
		...
		<div class="row page-titles">
			<div class="col-md-5 align-self-center">
				<h3 class="text-themecolor">ประเภทผู้ใช้และการเข้าถึง</h3>
			</div>
			<div class="col-md-7 align-self-center">
				<ol class="breadcrumb">
				<li class="breadcrumb-item">ตั้งค่า</a></li>
				<li class="breadcrumb-item"> ประเภทผู้ใช้และการเข้าถึง</li>
				</ol>
			</div>
		</div>
								...
								<div class="card-body">
									<div class="row padding-mps_product">
										...
										<div class="col-sm col-md-4 col-lg-3 mt-2">
                                        	<button onClick="loadModalPermis('myModalPermission')" class="btn btn-success waves-effect waves-light btn-block d-flex justify-content-between" type="button"><span class="btn-label"><i class="fa fa-gears"></i></span>เพิ่มประเภทผู้ใช้และการเข้าถึง<i></i></button>
										</div>
									</div><!-- row -->

									<div class="table-responsive pr-3 pl-3">
										<div id="myTable_wrapper" class="dataTables_wrapper no-footer">
											<table id="permission_datatable" class="table table-bordered table-striped nowrap">
		                                        <thead>
		                                            <tr>
														<th>ประเภท</th>
														<th>แก้ไข</th>
									...
									<div class="col-md-12 col-lg-12 p-t-10">
										<div class="row">
											<div class="col-sm-12 col-md-3 col-lg-2">
												<!-- <button type="button" id="del_store" name="del_requisition" class="btn btn-danger text-light btn-block mdi mdi-delete-empty"> ลบผู้ใช้งาน</button> -->
											</div>

 ...
 <div class="page-wrapper mt-main-wrapper-70">
		...
		<div class="row page-titles">
			<div class="col-md-5 align-self-center">
				<h3 class="text-themecolor">เพิ่มผู้ใช้งานระบบ</h3>
			</div>
			<div class="col-md-7 align-self-center">
				<ol class="breadcrumb">
				<li class="breadcrumb-item">ตั้งค่า</a></li>
				<li class="breadcrumb-item"> เพิ่มผู้ใช้งานระบบ</li>
				</ol>
			</div>
		</div>
								...
								<div class="card-body">
									<div class="row padding-mps_product">
										...
										<div class="col-sm col-md-4 col-lg-3 mt-2">
                                        	<button onClick="loadModal('myModalAddSettings')" class="btn btn-success waves-effect waves-light btn-block d-flex justify-content-between" type="button"><span class="btn-label"><i class="fa fa-plus"></i></span>เพิ่มผู้ใช้งาน<a></a></button>
										</div>
									</div><!-- row -->

									<div class="table-responsive pr-3 pl-3">
										<div id="myTable_wrapper" class="dataTables_wrapper no-footer">
											<table id="setting_datatable" class="table table-bordered table-striped nowrap">
		                                        <thead>
		                                            <tr>
		                                            	<th>#</th>
		                                                <th>ชื่อ</th>

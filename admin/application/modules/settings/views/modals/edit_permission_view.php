<?php
$attributes = array("id" => "edit_permission", "enctype"=>"multipart/form-data");
echo form_open(base_url('settings/edit_permission'), $attributes);
...
<div id="myModalEditPermission" class="modal fade in" tabindex="-1" role="dialog" aria-labelledby="myModalLabel2" aria-hidden="true">
  <div class="modal-dialog modal-xs">
      <div class="modal-content">
          <div class="modal-header bg-header-modals">
              <h4 class="modal-title text-light" id="myModalLabel2">แก้ไขประเภทผู้ใช้และการเข้าถึง</h4>
                      ...
                      <div class="col-md-12 col-lg-12 p-t-10 p-b-10 pl-0">
                          <div class="row">
                              ...
                              <div class="col-sm-12 col-md-12 col-lg-12">
                                  <input name="user_type_id" type="hidden" class="form-control" value="<?php echo $user_type_id; ?>">
                                  <input name="user_type_name" type="text" class="form-control" value="<?php echo $user_type_name; ?>" required>
                              </div>
                          </div>
                      </div>
                      <div class="col-md-12 col-lg-12 p-t-10 p-b-10 pl-0">
                        <div class="row">
                          ...
                          <?php
                            ...
                            foreach($modulesList_result as $row){
                              ...
                              $per_user_type_arr = explode(",",$per_user_type);
                              if(in_array($user_type_id, $per_user_type_arr)){
                                $checked = "checked";
                                $disabled  = "disabled";
                              }else{
                                $checked = "";
                              ...
                              $module = '<div class="col-md-6 col-lg-6"><input name="module[]" type="checkbox" id="basic_checkbox_'.$per_id.'" value="'.$per_id.'" class="filled-in chk-col-light-green" '.$checked.'>
                                <label for="basic_checkbox_'.$per_id.'" '.$display.'>'.$per_name_th.' </label>
                                </div>';
                              echo $module;

                              $module2 = '<input name="module2[]" type="checkbox" id="basic_'.$per_id.'" value="'.$per_id.'" class="filled-in chk-col-light-green" '.$checked.'>
                                <label for="basic_'.$per_id.'" style="display:none">'.$per_name_th.' </label>';
                              echo $module2;

 ...
 <div class="page-wrapper mt-main-wrapper-70">
		...
		<div class="row page-titles">
			<div class="col-md-5 align-self-center">
				<h3 class="text-themecolor">บัญชีเหรียญ</h3>
			</div>
			<div class="col-md-7 align-self-center">
				<ol class="breadcrumb">
				<li class="breadcrumb-item"> เหรียญ</a></li>
				<li class="breadcrumb-item"> บัญชีเหรียญ</a></li>
				</ol>
			</div>
		</div>
		<!-- ============================================================== -->
							...
							<div class="card">
								<div class="card-body">
									<div class="row padding-mps_product">
										<div class="col-sm-12 col-md-12 col-lg-12 pr-md-0 pr-lg-0">
									...
									<div class="table-responsive pr-3 pl-3">
										<div id="myTable_wrapper" class="dataTables_wrapper no-footer">
											<table id="account_datatable" class="table table-bordered table-striped nowrap">
		                                        <thead>
		                                            <tr>
		                                            	<th>สมาชิก</th>
		                                                <th>รายการทางบัญชี</th>
		                                                <th>จำนวนเหรียญ</th>
		                                                <th>ประวัติเหรียญ</th>

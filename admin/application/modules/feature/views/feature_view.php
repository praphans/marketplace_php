 ...
 <div class="page-wrapper mt-main-wrapper-70">
		...
		<div class="row page-titles">
			<div class="col-md-5 align-self-center">
				<h3 class="text-themecolor"> Featured</h3>
			</div>
								...
								<div class="card-body">
									<div class="row padding-mps_product">
										...
										<div class="col-sm col-md-4 col-lg-3 mt-2">
                                        	<button type="button" href="javascript:void(0)" data-toggle="modal" data-target="#myModalAddFeature" class="btn btn-success waves-effect waves-light btn-block d-flex justify-content-between" ><span class="btn-label"><i class="fa fa-plus"></i></span>เพิ่ม Feature สินค้า<a></a></button>
										</div>
									</div><!-- row -->

									<div class="table-responsive pr-3 pl-3">
										<div id="myTable_wrapper" class="dataTables_wrapper no-footer">
											<table id="feature_datatable" class="table table-bordered table-striped nowrap">
		                                        <thead>
		                                            <tr>
		                                            	<th>#</th>
		                                                <th>Feature สินค้า</th>
		                                                <th>ประเภท</th>
		                                                <th>รูปภาพ</th>
									...
									<div class="col-md-12 col-lg-12 p-t-10">
										<div class="row">
											<div class="col-sm-12 col-md-3 col-lg-2">
												<button type="button" id="del_feature" name="del_requisition" class="btn btn-danger text-light btn-block mdi mdi-delete-empty"> ลบ Feature สินค้า</button>
											</div>
...
<?php $this->load->assets_by_name('feature'); ?>   

<?php $this->load->view("modals/add_feature_view"); ?>

 ...
 <div class="page-wrapper mt-main-wrapper-70">
		...
		<div class="row page-titles">
			...
			<div class="col-md-7 align-self-center">
				...
				<li class="breadcrumb-item"><a href='<?php echo base_url("store/storeDescription/".$store_id); ?>'> รายละเอียดร้านค้า </a></li>
...
<script>
	...
	filteringOption();
	// loadItemstores(filtering,store_id);
</script>

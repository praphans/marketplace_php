...
foreach($product_discription as $row){
			...
			$product_type_result 				= $this->model_product->getproductTypeByID($product_type);
			$product_img_result 				= $this->model_product->getproductImgByID($product_id);
			$product_category_result 			= $this->model_product->getCategoryID($product_category);
			$product_review_result 				= $this->model_product->getReviewByID($product_id);
		...
		$relate_discription = $this->model_product->getRelateByID($product_relate_id);

		$product_name_result = $this->model_product->getProductNameByID($relate_id);
 ...
 <div class="page-wrapper mt-main-wrapper-70">
		...
		<div class="row page-titles">
			...
			<div class="col-md-7 align-self-center">
				<ol class="breadcrumb">
				<li class="breadcrumb-item"><a href='<?php echo base_url("product"); ?>'>สินค้า</a></li>
											...
											<div class="col-lg-12 col-md-12 col-sm-12 pt-3">
												<?php 
													foreach($relate_discription as $row){
														...
														$url_product_id = base_url("product/productDescription/".$product_relate);
											...
											<div class="comment-widgets m-b-20">
												<?php 
													foreach($product_review_result as $row){
														...
														$thaidate 		 = $this->product_libs->getThaiDate($timestamp);
														$member_result   = $this->model_product->getMemberByID($member_id);
														$review_type_result = $this->model_product->getReviewTypeByID($review_type);
...
<?php $this->load->assets_by_name('product_modals_image'); ?>  

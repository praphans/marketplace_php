...
<!-- ============================================================== -->  
<?php
$attributes = array('id' => 'add_store');
echo form_open(base_url('category/add_store'), $attributes);
?>
<div id="myModalAddstore" class="modal fade in" tabindex="-1" role="dialog" aria-labelledby="myModalLabel2" aria-hidden="true">
  <div class="modal-dialog modal-xs">
      <div class="modal-content">
          <div class="modal-header bg-header-modals">
              <h4 class="modal-title text-light" id="myModalLabel2">เพิ่มหมวดหมู่ร้านค้า</h4>
          ...
          <div class="modal-footer d-flex justify-content-center">
              <div class="row w-100">
                  ...
                  <div class="col-sm-12 col-md-4 button-group text-center btn-footer">
                   ...
                   <div class="col-sm-12 col-md-4 button-group text-center btn-footer ">
                       <button type="submit" class="btn btn-info waves-effect btn-block">เพิ่มหมวดหมู่ร้านค้า</button>
                  </div>                 
              </div>
          </div>

 ...
 <div class="page-wrapper mt-main-wrapper-70">
		...
		<div class="row page-titles">
			<div class="col-md-5 align-self-center">
				<h3 class="text-themecolor">คำขอเข้าร่วมโปรโมชั่น</h3>
			</div>
			<div class="col-md-7 align-self-center">
				<ol class="breadcrumb">
				<li class="breadcrumb-item">โปรโมชั่น</a></li>
				<li class="breadcrumb-item"> คำขอเข้าร่วมโปรโมชั่น</li>
				</ol>
			</div>
		</div>
								...
								<div class="card-body">
									...
									<div class="table-responsive pr-3 pl-3">
										<div id="myTable_wrapper" class="dataTables_wrapper no-footer">
											<table id="promo_request_datatable" class="table table-bordered table-striped">
		                                        <thead>
		                                            <tr>
		                                                <!-- <th>วันที่</th> -->
		                                                <th>ชื่อโปรโมชั่น</th>
...
<?php $this->load->assets_by_name('promo_request'); ?>   

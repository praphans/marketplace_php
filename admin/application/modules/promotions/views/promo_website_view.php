 ...
 <div class="page-wrapper mt-main-wrapper-70">
		...
		<div class="row page-titles">
			<div class="col-md-5 align-self-center">
				<h3 class="text-themecolor">รวมโปรโมชั่น</h3>
			</div>
			<div class="col-md-7 align-self-center">
				<ol class="breadcrumb">
				<li class="breadcrumb-item">โปรโมชั่น</a></li>
				<li class="breadcrumb-item"> รวมโปรโมชั่น</li>
				</ol>
			</div>
		</div>
								...
								<div class="card-body">
									<div class="row padding-mps_product">
										...
										<div class="col-sm col-md-4 col-lg-3 mt-2">
											<button type="button" href="javascript:void(0)" data-toggle="modal" data-target="#myModalAddPromoWeb" class="btn btn-success waves-effect waves-light btn-block d-flex justify-content-between" ><span class="btn-label"><i class="fa fa-plus"></i></span>เพิ่มโปรโมชั่นเว็บไซต์<a></a></button>
										</div>
									</div><!-- row -->

									<div class="table-responsive pr-3 pl-3">
										<div id="myTable_wrapper" class="dataTables_wrapper no-footer">
											<table id="promo_website_datatable" class="table table-bordered table-striped nowrap">
		                                        <thead>
		                                            <tr>
		                                            	<th>#</th>
		                                                <th>ชื่อโปรโมชั่น</th>
									...
									<div class="col-md-12 col-lg-12 p-t-10">
										<div class="row">
											<div class="col-sm-12 col-md-3 col-lg-2">
												<button type="button" id="del_promo_web" name="del_promo_web" class="btn btn-danger text-light btn-block mdi mdi-delete-empty"> ลบโปรโมชั่นเว็บไซต์</button>
											</div>
...
<?php $this->load->assets_by_name('promo_website'); ?>   
<?php $this->load->view("modals/add_promo_website_view"); ?>
<div id="promo_website_container"></div>
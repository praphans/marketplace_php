 ...
 <div class="page-wrapper mt-main-wrapper-70">
		...
		<div class="row page-titles">
			<div class="col-md-5 align-self-center">
				<h3 class="text-themecolor">บัญชีผู้ซื้อ</h3>
			</div>
			<div class="col-md-7 align-self-center">
				<ol class="breadcrumb">
				<li class="breadcrumb-item">ช่วยเหลือ</a></li>
				<li class="breadcrumb-item"> บัญชีผู้ซื้อ</li>
				</ol>
			</div>
		</div>
								...
								<div class="card-body">
									...
									<div class="row padding-mps_product">
										...
										<div class="col-md-2 col-lg-3 mt-2">
											<select class="form-control custom-select" name="faq_cat_id" id="faq_cat_id" onchange="filteringOption();">
										...
										<div class="col-md-4 col-lg-3 mt-2">
											<button type="button" href="javascript:void(0)" data-toggle="modal" data-target="#myModalAddFaqBuy" class="btn btn-success waves-effect waves-light btn-block d-flex justify-content-between" ><span class="btn-label"><i class="fa fa-plus"></i></span>เพิ่มคำถามที่พบบ่อย<a></a></button>
										</div>
									...
									<div class="table-responsive pr-3 pl-3">
										<div id="myTable_wrapper" class="dataTables_wrapper no-footer">
											<table id="faqBuy_datatable" class="table table-bordered table-striped">
		                                        <thead>
		                                            <tr>
		                                            	<th>#</th>
		                                            	<th>วันที่</th>
									...
									<div class="col-md-12 col-lg-12 p-t-10">
										<div class="row">
											<div class="col-sm-12 col-md-4 col-lg-2">
												<button type="button" id="del_faq_buy" name="del_faq_buy" class="btn btn-danger text-light btn-block mdi mdi-delete-empty"> ลบคำถามที่พบบ่อย</button>
											</div>
...
<?php $this->load->view("modals/add_buy_view"); ?>
<div id="buy_container"></div>
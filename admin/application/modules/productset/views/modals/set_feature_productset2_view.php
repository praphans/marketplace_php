...
echo form_open(base_url('productset/updateSetFeature2'), $attributes);
?>
                                    ...
                                    <select class="form-control custom-select" name="product_featured" id="product_featured" >
                                      ...
                                      <?php
                                        ...
                                        foreach($feature_list as $row){
                                          ...
                                          if($product_featured == $feature_id){
                                            $selected = "selected";
                                          }else{
                                            $selected = "";
                                          }
                                      ?>
                                      <option value="<?php echo $feature_id;?>" <?php echo $selected;?>><?php echo $featured_name; ?></option>
                                      <?php } ?>
                                  </select>
                                </div>
                            </div>

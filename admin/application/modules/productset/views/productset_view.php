 ...
 <div class="page-wrapper mt-main-wrapper-70">
		...
		<div class="row page-titles ">
			<div class="col-md-5 align-self-center">
				<h3 class="text-themecolor">สินค้าตั้งแสดง</h3>
			</div>
			<div class="col-md-7 align-self-center">
				<ol class="breadcrumb">
				<li class="breadcrumb-item"> สินค้าตั้งแสดง</li>
				</ol>
			</div>
		</div>
		<!-- ============================================================== -->
								...
								<div class="card-body">
									...
									<div class="table-responsive pr-3 pl-3">
										<div id="myTable_wrapper" class="dataTables_wrapper no-footer">
											<table id="productset_datatable" class="table table-bordered table-striped ">
		                                        <thead>
		                                            <tr>
		                                            	<th>#</th>
		                                                <th>รหัสสินค้า</th>
									...
									<div class="col-md-12 col-lg-12 p-t-10">
										<div class="row">
											...
											<div class="col-sm-12 col-md-4 col-lg-3 pb-2">
												<button type="button" id="add_recommended" name="add_recommended" class="btn btn-warning text-light btn-block mdi mdi-star-circle" > บันทึกสินค้าแนะนำ</button>
											</div>
...
<?php $this->load->assets_by_name('productset_admin'); ?>  

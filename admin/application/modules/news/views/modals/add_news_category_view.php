...
<?php
$attributes = array("id" => "add_news_category", "enctype"=>"multipart/form-data");
echo form_open(base_url('news/add_news_category'), $attributes);
?>
<div id="myModalAddNewsCategory" class="modal fade in" tabindex="-1" role="dialog" aria-labelledby="myModalLabel2" aria-hidden="true">
  <div class="modal-dialog modal-xs">
      <div class="modal-content">
          <div class="modal-header bg-header-modals">
              <h4 class="modal-title text-light" id="myModalLabel2">เพิ่มหมวดหมู่บทความ</h4>
          ...
          <div class="modal-footer d-flex justify-content-center">
              <div class="row w-100">
                  ...
                  <div class="col-sm-12 col-md-4 button-group text-center btn-footer">
                   ...
                   <div class="col-sm-12 col-md-4 button-group text-center btn-footer ">
                       <button type="submit" class="btn btn-info waves-effect btn-block">เพิ่มหมวดหมู่บทความ</button>
                  </div>                 
              </div>
          </div>

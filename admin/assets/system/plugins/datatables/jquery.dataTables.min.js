...
d[c]=e,"o"===b[1]&&Y(a[e])});a._hungarianMap=d}function J(a,b,c){a._hungarianMap||Y(a);var d;h.each(b,function(e){d=a._hungarianMap[e];if(d!==k&&(c||b[d]===k))"o"===d.charAt(0)?(b[d]||(b[d]={}),h.extend(!0,b[d],b[e]),J(a[d],b[d],c)):b[d]=b[e]})}function Fa(a){var b=m.defaults.oLanguage,c=a.sZeroRecords;!a.sEmptyTable&&(c&&"ไม่มีข้อมูลในตาราง"===b.sEmptyTable)&&F(a,a,"sZeroRecords","sEmptyTable");!a.sLoadingRecords&&(c&&"Loading..."===b.sLoadingRecords)&&F(a,a,"sZeroRecords","sLoadingRecords");
...
sSortDescending:": activate to sort column descending"},oPaginate:{sFirst:"เริ่มต้น",sLast:"ท้ายสุด",sNext:"ต่อไป",sPrevious:"ย้อนกลับ"},sEmptyTable:"ไม่มีข้อมูลในตาราง",sInfo:"แสดง _START_ ถึง _END_ จาก _TOTAL_ รายการ",sInfoEmpty:"แสดง 0 ถึง 0 จาก 0 รายการ",sInfoFiltered:"(ค้นหาข้อมูลจาก _MAX_ รายการ)",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"แสดง _MENU_ รายการ",sLoadingRecords:"Loading...",sProcessing:"Processing...",sSearch:"ค้นหา:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"ไม่พบข้อมูลที่ตรงกัน"},

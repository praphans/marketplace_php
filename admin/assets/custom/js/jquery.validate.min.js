...
jQuery.extend(jQuery.validator.messages, {
		...
		url: "กรุณาระบุ URL ให้ถูกต้อง.",
		date: "กรุณาระบุวันที่ให้ถูกต้อง.",
		dateISO: "โปรดป้อนวันที่ที่ถูกต้อง (ISO).",
		number: "กรุณาระบุตัวเลขให้ถูกต้อง.",
		digits: "กรุณาระบุตัวเลขเท่านั้น.",
		creditcard: "Please enter a valid credit card number.",
		equalTo: "กรุณาระบุข้อมูลที่เหมือนกัน.",
		accept: "โปรดป้อนค่าพร้อมส่วนขยายที่ถูกต้อง.",
		maxlength: jQuery.validator.format("กรุณากรอกไม่เกิน {0} ตัวอักษร."),
		minlength: jQuery.validator.format("กรุณากรอกไม่น้อยกว่า {0} ตัวอักษร."),
		rangelength: jQuery.validator.format("กรุณาใส่ค่าระหว่าง {0} และ {1} ตัวอักษร."),
